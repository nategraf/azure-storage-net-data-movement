//------------------------------------------------------------------------------
// <copyright file="PipelinedBlockBasedBlobReader.cs" company="Microsoft">
...
namespace Microsoft.WindowsAzure.Storage.DataMovement.TransferControllers
{
    ...
    internal sealed class PipelinedBlockBasedBlobReader : TransferReaderWriterBase
    {
        /// <summary>
        ...
        public PipelinedBlockBasedBlobReader(
